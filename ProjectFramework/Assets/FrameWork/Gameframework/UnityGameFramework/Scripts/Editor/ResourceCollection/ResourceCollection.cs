...
namespace UnityGameFramework.Editor.ResourceTools
{
    ...
    public sealed class ResourceCollection
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<ResourceCollectionConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "FrameWork/GameFramework/Configs/ResourceCollection.xml"));
