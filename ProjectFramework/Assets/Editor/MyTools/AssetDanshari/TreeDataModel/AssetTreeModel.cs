...
namespace AssetDanshari
{
    public class AssetTreeModel
    {
        ...
        protected List<string> refPaths { get; private set; }
        protected List<string> resPaths { get; private set; }
        protected List<string> commonPaths { get; private set; }
        ...
        public virtual void SetDataPaths(string refPathStr, string pathStr, string commonPathStr)
        {
            ...
            resPaths = new List<string>();
            commonPaths = new List<string>();
            data = null;
            ResetAutoId();
            assetPaths = pathStr;
            foreach (var item in refPathStr.SplitToStringList(';'))
            {
                refPaths.AddRange(AssetDanshariUtility.PathStrToList(item));
            }
            foreach (var item in pathStr.SplitToStringList(';'))
            {
                resPaths.AddRange(AssetDanshariUtility.PathStrToList(item));
            }
            commonPaths = AssetDanshariUtility.PathStrToList(commonPathStr);
        ...
        protected AssetInfo DirToAssetInfoTree(List<string> paths)
        {
            var rooInfo = new AssetInfo(GetAutoId(), String.Empty, String.Empty);
            rooInfo.isFolder = true;
