...
namespace AssetDanshari
{
    public class AssetDanshariStyle
    {
        public class Style
        {
            public GUIContent addPath = new GUIContent("+");
            public GUIContent subPath = new GUIContent("-");
            ...
            public GUIContent assetReferenceCheckRule = new GUIContent("规范检查");
            ...
            public GUIContent dependenciesFileSize = new GUIContent("运行占用");
