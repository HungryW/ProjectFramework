    ...
    SubShader
    {
        CGINCLUDE
            ...
            v2f vert_ver(appdata_img v)
            {
                ...
                o.uv[0] = uv;
                o.uv[1] = uv + half2( 0.0, _MainTex_TexelSize.x*1.0)*_BlurSize;
                o.uv[2] = uv - half2( 0.0, _MainTex_TexelSize.x*1.0)*_BlurSize;
                o.uv[3] = uv + half2( 0.0, _MainTex_TexelSize.x*2.0)*_BlurSize;
                o.uv[4] = uv - half2( 0.0, _MainTex_TexelSize.x*2.0)*_BlurSize;
