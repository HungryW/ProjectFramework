...
public class BoxOutline : ModifiedShadow
{
    ...
    public void ChangeOutlineColor(float r, float g, float b, float a)
    {
        effectColor = new Color(r,g,b,a);
    }

    public void ChangeOutlineColor(string hexadecimal)
    {
        ...
        Debug.LogWarning("OUTLINE_COLOR_CHANGE_ERR:"+hexadecimal);
    }
    ...
    public void ChageOutLineSize(float size)
    {
        effectDistance = new Vector2(size,size);
        graphic.SetAllDirty();
    }
}
